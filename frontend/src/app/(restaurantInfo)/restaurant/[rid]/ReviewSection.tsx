    ...
    return(
        <div className='w-full text-center flex flex-col items-center justify-center'>
                ...
                <div className='relative border-black border-2 w-1/2 rounded-3xl bg-[#f5f5f5] '>
                    <input className='focus:outline-none w-[90%] h-20  bg-[#f5f5f5] resize-none' onChange={(e) => setComment(e.target.value)} value={comment} placeholder='let show your opinion...'></input>
