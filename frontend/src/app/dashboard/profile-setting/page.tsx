        ...
        <div className="flex flex-col gap-[10%] items-start w-full pr-[17%] ml-[5%]">
            ...
            <form onSubmit={handleUpdate} className="w-full flex flex-col gap-[10%] h-full">
                <div>
                    ...
                    <input className="w-full px-3 py-1 text-base border border-stone-800 bg-stone-100 text-stone-800 focus:outline-none focus:ring-2 focus:ring-stone-500"
                ...
                <div className="flex flex-row gap-[5%]">
                    <Link href={'/dashboard'}>
                        <button className="w-full px-8 py-2 text-center bg-stone-100 text-stone-800 border border-stone-800 focus:outline-none focus:ring-2 focus:ring-stone-500 hover:bg-stone-800 hover:text-stone-100">
                            &lt;- Back
                        </button>
                    </Link>
                    <button className="w-full px-8 py-2 text-center bg-stone-100 text-stone-800 border border-stone-800 focus:outline-none focus:ring-2 focus:ring-stone-500 hover:bg-stone-800 hover:text-stone-100"
