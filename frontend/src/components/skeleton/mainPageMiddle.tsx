...
export default function MainPageMiddleSkeleton() {
        ...
        return (
            <div className="flex flex-row justify-evenly w-[100%] h-full pl-9 overflow-y-auto animate-pulse ">
                {skeletonItems.map((item) => (
                    <div key={item} className="flex flex-col items-start justify-between gap-0 pb-4 bg-gray-200 w-[60%] lg:w-1/5 h-[40vh] rounded-md">
