...
router
  .route("/")
  .get(getRestaurants)
  .post(protect, authorize("admin", "manager"), createRestaurant);
router
  .route("/:id")
  .get(getRestaurant)
  .put(protect, authorize("admin", "manager"), updateRestaurant)
  .delete(protect, authorize("admin", "manager"), deleteRestaurant);
